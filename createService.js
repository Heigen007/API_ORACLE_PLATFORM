...
async function createService(oracledb, data) {
    try {
      ...
      await connection.execute(`INSERT INTO REST_WEB_METHODS VALUES (${methodId}, '${data.ENDPOINT}', ${data.IS_ENABLED ? 1 : 0}, '${data.HTTP_METHOD}')`);
      ...
      if (connection) {
        ...
        createLog('CREATE_SERVICE', 'ERROR', 'Connection doesn`t exist')
      }
    }
}
